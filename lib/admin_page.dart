...
class _AdminPageState extends State<AdminPage> with TickerProviderStateMixin {
  ...
  final List<String> roleOptions = ['reseller', 'owner', 'member'];
    ...
    return Row(
      ...
      children: [
        IconButton(
          ...
          color: currentPage > 1 ? accentRed : Colors.grey,
        ),
        ...List.generate(totalPages > 5 ? 5 : totalPages, (index) {
          ...
          return Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: currentPage == page ? accentRed : cardDarker,
                foregroundColor: currentPage == page ? Colors.white : Colors.white70,
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8),
                  side: BorderSide(
                    color: currentPage == page ? accentRed : Colors.white.withOpacity(0.2),
                  ),
                ),
                elevation: 0,
              ),
        ...
        IconButton(
          ...
          color: currentPage < totalPages ? accentRed : Colors.grey,
        ),
      ],
    );
  }
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isSelected ? accentRed.withOpacity(0.2) : Colors.transparent,
            borderRadius: BorderRadius.circular(12),
          ),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(
                icon,
                color: isSelected ? accentRed : Colors.white.withOpacity(0.6),
                size: 24,
              ),
              const SizedBox(height: 4),
              Text(
