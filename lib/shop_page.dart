...
class _ShopPageState extends State<ShopPage> with TickerProviderStateMixin {
  ...
  void _navigateToRoleShop() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RoleShopBalancePage(
  ...
  void _navigateToBugShop() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BugShopPage(
          username: widget.username,
          password: widget.password,
          sessionKey: widget.sessionKey,
          role: widget.role,
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  "Choose your preferred shop service below.",
                  style: TextStyle(
                    color: Colors.white.withOpacity(0.4),
                    fontSize: 10,
                    letterSpacing: 0.2,
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildShopButton(
                    ...
                    title: "Bug Shop",
                    description: "Purchase premium bug tools",
                    color: accentRed,
                    onTap: _navigateToBugShop,
                  ),
